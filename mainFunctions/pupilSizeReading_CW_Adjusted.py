...
def pupilSizeReading_CW_Adjusted(cameraStrobe,dataFileBaseFolder,darkMode = False,\
    ...
    totalNumberOfSavedFrames = len(pupilSmoothArea)
    ...
    lastCapturedFrame_Sample = framesStartSample[totalNumberOfSavedFrames-26]#framesStartSample[totalNumberOfSavedFrames]
